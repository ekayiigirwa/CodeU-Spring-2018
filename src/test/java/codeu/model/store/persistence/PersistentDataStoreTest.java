...
public class PersistentDataStoreTest {
  ...
  public void testSaveAndLoadUsers() throws PersistentDataStoreException {
    ...
    Instant loginOne = Instant.ofEpochMilli(1000);
    inputUserOne.setLoginTime(loginOne);
    ...
    Instant loginTwo = Instant.ofEpochMilli(1000);
    inputUserTwo.setLoginTime(loginTwo);
    ...
    Assert.assertEquals(loginOne, resultUserOne.getLoginTime());
    ...
    Assert.assertEquals(loginTwo, resultUserTwo.getLoginTime());
  }
